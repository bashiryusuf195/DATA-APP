  ...
  return (
    <div className="space-y-12">
      ...
      <div className="text-center space-y-4 pt-4">
        ...
        <p className="text-base text-gray-500 dark:text-white/50 max-w-xl mx-auto leading-relaxed">
      ...
      {/* Mission */}
      <section className="bg-white dark:bg-white/[0.03] border border-gray-200 dark:border-white/8 rounded-2xl p-7 space-y-3">
      ...
      <section className="space-y-5">
        <h2 className="text-lg font-bold text-gray-900 dark:text-white">What we offer</h2>
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
          {SERVICES.map(({ icon: Icon, label, desc }) => (
            <div
              key={label}
              className="flex gap-3 items-start bg-white dark:bg-white/[0.03] border border-gray-200 dark:border-white/8 rounded-xl p-4"
            >
              ...
              <div>
                ...
                <p className="text-xs text-gray-400 dark:text-white/40 mt-0.5 leading-relaxed">{desc}</p>
              </div>
            </div>
          ))}
        </div>
      ...
      <section className="bg-white dark:bg-white/[0.03] border border-gray-200 dark:border-white/8 rounded-2xl p-7 space-y-4">
        <h2 className="text-lg font-bold text-gray-900 dark:text-white">Our values</h2>
        <ul className="space-y-3 text-sm text-gray-500 dark:text-white/55 leading-relaxed">
          <li><span className="font-semibold text-gray-700 dark:text-white/80">Reliability</span> — We work with multiple service providers and route requests intelligently to maximise uptime.</li>
          <li><span className="font-semibold text-gray-700 dark:text-white/80">Transparency</span> — Prices and service charges are shown before you confirm any transaction.</li>
          <li><span className="font-semibold text-gray-700 dark:text-white/80">Security</span> — Your wallet is PIN-protected. Sensitive identity data (BVN, NIN) is encrypted and never shared with third parties except where required by law or for direct service delivery.</li>
          <li><span className="font-semibold text-gray-700 dark:text-white/80">Accountability</span> — Failed transactions are investigated and resolved. Confirmed failures are automatically refunded to your wallet.</li>
        </ul>
      </section>

      {/* CTA */}
      <div className="text-center pt-2">
        <p className="text-sm text-gray-400 dark:text-white/40 mb-4">Have questions or need support?</p>
        <Link
          to="/contact"
